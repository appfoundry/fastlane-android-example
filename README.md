...
Although fastlane is not yet equipped with the same tools for Android as it is for iOS we enjoyed the experience and will continue to work with fastlane for both iOS and Android in the future. This solution suits or needs, there is always room for improvements. Feel free to recommend improvements or make a pull request.
